...
//                this.todayDate(),this.todayDate());
    ...
    public User findByEmailAndPwd(User user) {
        ...
        List<User> list=jdbcTemplate.query(sql,new MyResult(),user.getEmail(),user.getPassword());
    ...
    public void updateUser(User user) {
        String sql ="UPDATE user SET UserName=?,PassWord=?,Email=?,Birthday=?,Gender=?,DataChange_LastTime=?  WHERE Id=?;";
        jdbcTemplate.update(sql,user.getUserName(),user.getPassword(),user.getEmail(),user.getBirthday(),user.getGender(),nowTime.getNowTime(),user.getId());
